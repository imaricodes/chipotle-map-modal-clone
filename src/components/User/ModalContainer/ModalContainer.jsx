...
const ModalContainer = () => {
  ...
  const { locationModalActive, setLocationModalActive, setNearbyResults, setDeliveryLocation, setDeliveryModeActive, setPickupInfoModalActive, setShowPickupDetail, setSelectedStore } = useContext(SearchAreaContext);
  ...
  useEffect(() => {
    console.log("modal container rendered: ", searchhContainerRenderCounted.current++);
  })
